...
agent.add_custom_function(allora_network_client.get_function("get_all_topics"))
agent.add_custom_function(allora_network_client.get_function("get_inference_by_topic_id"))
agent.add_custom_function(allora_network_client.get_function("get_price_prediction"))


response = agent.react(
    session_id="test_session_1",
    platform="telegram",
    event="What's the price of BTC in 5min?",
